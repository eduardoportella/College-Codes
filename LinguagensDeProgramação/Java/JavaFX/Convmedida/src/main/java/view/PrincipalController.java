...
public class PrincipalController implements Initializable {
    ...
    private final ChangeListener<? super String> listenerDe //bloqueia a entrada de caracteres q nao sejam numeros do txtFld da esquerda
    ...
    private final ChangeListener<? super String> listenerPara //bloqueia a entrada de caracteres q nao sejam numeros do txtFld da direita
            = (observable, oldValue, newValue) -> {
                if (!newValue.matches("\\d*(\\" + ds + "\\d*)?") && !newValue.isEmpty()) {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        medidas.add(new Medida("Metro", "M", "Polegada", "pol", 39.37));
        ...
        cmbbxMedidas.valueProperty().addListener(
            ...
            @Override
            public void changed(ObservableValue<? extends Medida> observable, //seta as siglas
