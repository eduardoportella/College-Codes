...
public class DAOContato {
    ...
    public boolean excluir(int id)
    {
        ...
        r = con.excluir("DELETE FROM public.contato WHERE cod_contato = "+id);
    ...
    public Contato getById(String id)
    {
        ...
        ResultSet r = con.pesquisar("SELECT * FROM public.contato WHERE cod_contato = "+id);
    ...
    public boolean alterar(Contato c)
    {
        ...
        r = con.atualizar("UPDATE public.contato SET nome='"+c.getNome()+"', email='"+c.getEmail()+"', telefone='"+c.getTelefone()+"' WHERE cod_contato = "+c.getCod_contato());
